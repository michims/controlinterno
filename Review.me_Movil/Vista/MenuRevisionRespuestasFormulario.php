...
<div class="home-content">
  ...
  <div class="contenido" style="text-align:center;">
          ...
          <br>
          <h2>Menú Respuestas Formulario Autoevaluación</h2>
          <br>
        ...
        <a href="EncargadoRevisionRespuestasFormulario.php">
        <button class="submit" type="button" onclick="Tarjetaresult()"  align="center" style="font-size:18px">Revisión de Respuestas Formulario por Departamento</button></a>
        <br>
        <br>
        <a href="EncargadoControlResumenEstadisticas.php">
        <button class="submit" type="button" onclick="Tarjetaestad()"  align="center" style="font-size:18px">Resumen de Información General</button></a>
...
window.location.href="EncargadoRevisionRespuestasFormulario.php";
}
function Tarjetaestad(){
window.location.href="EncargadoControlResumenEstadisticas.php";
}
