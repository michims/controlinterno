...
<h3>Resultados Formulario para Departamento por Componente</h3>
	...
	<div class="popup">
		<center><h3>Desglose Información Componente</h3></center>
      ...
      <thead>
        <tr>
          <th style="width:50%;"><div style="width:50%">Característica</div></th>
          <th>Opción</th>
          <th>Valor</th>
        </tr>
      </thead><thead>
...
function InfoGen(comp){
    ...
    $.ajax({
      ...
      { if(response!=""){
        ...
        mensaje("Se han cargado los resultados del componente para el período de evaluación","success")
      }
