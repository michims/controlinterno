...
<div class="home-content">
  ...
  <div class="contenido" style="text-align:center;">
   ...
   <div class=" grid-wrapper2" >
        <div class="card zone " onclick="Tarjetaresult()" text-align="center" ></a>
      ...
      <div class="card zone" onclick="Tarjetaestad()" text-align="center">
...
window.location.href="AdmiResultadosEvaluacion.php";
}
function Tarjetaestad(){
window.location.href="ResumenEstadisticas.php";
}
