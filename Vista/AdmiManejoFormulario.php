...
<div class="home-content">
  ...
  <div class="contenido" style="text-align:center;">
   ...
   <div class="contenedor1" onclick="Tarjetaperiodo()">
         <figure>
             ...
             <div class="capa1">
               ...
               <br>
               <br>
                 <h3>Configurar Periodo Formulario</h3>
                 
             </div>
         </figure>
        </div>
      
        <div class="contenedor1" onclick="Tarjetamodificar()">
          <figure>
              <img src="./img/modificacion.png">
              <div class="capa1">
                <br>
                <br>
                <br>
...
window.location.href="AdmiConfiguracionPeriodo.php";
}

function Tarjetamodificar(){
window.location.href="AdmiModificacionFormulario.php";
}
</script>
