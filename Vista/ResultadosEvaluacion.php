  ...
  <section class="home-section">
    ...
    <div class="home-content">
      ...
      <div class="contenidoresultado">
       ...
       echo "<tr><td>". $row ['NombreComponente']."</td><td>" . $row['NombreCaracteristica'] . "</td><td>" . $row['NombreOpcion'] ."</td><td>". 
       $row ['ValorOpcion']."</td><td>". $row ['EvidenciaNecesaria']."</td><td>". 
         $row ['DocFaltante']."</td><td>". $row ['Problemas']."</td><td>". $row ['Compromisos']."</td><td>". $row ['Estado']."</td></tr>";
         }
         if ($count!=0 || $suma!=0){
         $prom=$suma/$count;
         }
       ...
       ?>
        ...
        <center>
          ...
          <br>
          <div>
          <button class="submit" type="button" onclick="Revisar()" style="width:20%" align="center" >Enviar a Revisión</button>
          ...
          <hr>
          <br>
        <h3>Índice de Madurez Promedio: <?php echo $prom;?></h3>
        </center>
      </div>
