...
if ($tipo=="registro"){
    ...
    $opcion7=$_REQUEST["mejora"];
    require '../Modelo/ConsultasModel.php';
    require_once '../Config.php';
    $objconfig = new Config();
    $objsm =  new ConsultasModel($objconfig);
    $result2=$objsm->RegistroResultadoFormulario($opcion1,$depa,$opcion2,$opcion3,$opcion5,$opcion6,$opcion7); 
    echo $result2;
}
...
if ($tipo=="infoForm"){
    ...
    while ($row = mysqli_fetch_array($result)){
       ...
       .";". $row ['DocFaltante'].";". $row ['Problemas'].";". $row ['Compromisos'];
        }
        echo $info;
    }
...
if ($tipo=="actualizar"){
    ...
    $mejor=$_REQUEST["mejora"];
    require '../Modelo/ConsultasModel.php';
    require_once '../Config.php';
    $objconfig = new Config();
    $objsm =  new ConsultasModel($objconfig);
    $objsm->ActualizarResultadoFormulario($res,$op,$evid1,$docfalt,$prob,$mejor);
}
